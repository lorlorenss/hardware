...
# Automatically run 'firefox --remote-debugging-port=9222 --kiosk' in the command prompt
...
def run_id_script():
    command = 'nohup lxterminal -e "bash -c \'source /home/admin/myenv/bin/activate && python3 /home/admin/ID.py\'" &'
        ...
        if current_url:
            if current_url != previous_url:
                if current_url.endswith("/landingPage"):
                    ...
                    print("Python3 should be open by now")
                    run_id_script()
